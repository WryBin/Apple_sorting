...
def img_graying(img_in, gray_method):
    """1.The R channel method 2.The maximum value method 3.mean method 4.Weighted mean method"""
    ...
    # return gray
    if gray_method == 1:  # The R channel method
        gray = img_in[:, :, 0]
...
def img_de_noising(img_in, de_no_method):
    """
    1. MeanBlur 2. MedianBlur 3. GaussianBlur 4. cv2.fastNlMeansDenoising
